...
export function getSaveCircle(address) {
    return getContract({
        address,
        abi: saveCircleAbi,
        client: publicClient,
...
(function (IntentType) {
    IntentType[IntentType["JOIN_CIRCLE"] = 0] = "JOIN_CIRCLE";
    IntentType[IntentType["LEAVE_CIRCLE"] = 1] = "LEAVE_CIRCLE";
    IntentType[IntentType["ADJUST_CONTRIBUTION"] = 2] = "ADJUST_CONTRIBUTION";
})(IntentType || (IntentType = {}));
// CircleState enum (matches Solidity)
export var CircleState;
(function (CircleState) {
    CircleState[CircleState["FORMING"] = 0] = "FORMING";
    CircleState[CircleState["ACTIVE"] = 1] = "ACTIVE";
    CircleState[CircleState["PAUSED"] = 2] = "PAUSED";
    CircleState[CircleState["COMPLETE"] = 3] = "COMPLETE";
    CircleState[CircleState["DISSOLVED"] = 4] = "DISSOLVED";
